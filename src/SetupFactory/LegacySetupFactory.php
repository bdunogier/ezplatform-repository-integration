 ...
 */
namespace App\SetupFactory;

use AppKernel;
use Symfony\Component\DependencyInjection\ContainerBuilder;
use eZ\Publish\API\Repository\Tests\SetupFactory as RepositorySetupFactory;
 ...
 */
class LegacySetupFactory extends RepositorySetupFactory
{
    /**
     * Data source name.
     *
    ...
    {
        /** @var $handler \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Handler */
    ...
    {
        if (self::$db === 'pgsql') {
            $setvalPath = __DIR__ . '/../lib/Persistence/_fixtures/setval.pgsql.sql';
    ...
    protected function getInitialData()
    {
        if (!isset(self::$initialData)) {
            self::$initialData = include __DIR__ . '/../../vendor/ezsystems/ezplatform-legacy-storage/tests/integration/_fixtures/clean_ezdemo_47_dump.php';
        }
    ...
    {
        $schemaPath = __DIR__ . '/../../vendor/ezsystems/ezplatform-legacy-storage/tests/lib/Persistence/_fixtures/schema.' . self::$db . '.sql';
    ...
    public function getServiceContainer()
    {
        ...
        if (!isset(self::$serviceContainer)) {
            $kernel = new AppKernel('legacy', true, self::$ioRootDir);
            $kernel->boot();
